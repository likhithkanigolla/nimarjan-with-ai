...
export type StageKey =
  "OBSERVE" | "DETECT" | "PREDICT" | "SIMULATE" | "RECOMMEND" | "APPROVE" | "ADAPT";
...
export interface Kpi {
  ...
  value: string;
  delta?: string;
  tone?: "safe" | "warn" | "risk" | "critical" | "info";
}
...
export interface DecisionPanel {
  ...
  prediction?: {
    ...
    items?: Array<{ label: string; value: string; tone?: Kpi["tone"] }>;
  };
  simulation?: {
    title: string;
...
export interface ScenarioStep {
  ...
  activeRoutes?: Array<{
    id: string;
    style: "primary" | "alt" | "emergency" | "closed" | "selected" | "faded";
  }>;
  heatZones?: HeatZone[];
  flows?: FlowArrow[];
  moving?: MovingEntity[];
...
export const scenario1: Scenario = {
  id: "scenario1",
  name: "Crowd Risk Prediction & Emergency Response",
  headline: "Immersion Point IP-03 · Live safety forecast",
  stages: stagesFull,
  steps: [
    {
      id: 1,
      ...
      stage: "OBSERVE",
      cue: "Current crowd is still within capacity. Show that the prediction comes before the incident.",
      mapCenter: IP03,
      mapZoom: 15,
      ...
      alerts: [
        { severity: "INFO", text: "Agentic AI platform synchronized — IP-03 telemetry live" },
      ],
    },
    {
      id: 2,
      ...
      stage: "PREDICT",
      cue: "Reveal the predicted state. Emphasize now vs +10 minutes.",
      mapCenter: IP03,
      mapZoom: 15,
      ...
      alerts: [
        { severity: "WARNING", text: "Projected crowd threshold breach at IP-03 in 10 minutes" },
      ],
      timeline: [
        { time: "20:35", text: "Crowd inflow rising" },
        { time: "20:40", text: "Critical density predicted" },
      ],
    },
    {
      id: 3,
      ...
      stage: "RECOMMEND",
      cue: "Explain the four coordinated actions. Human approval is required.",
      mapCenter: IP03,
      mapZoom: 15,
      layers: {
        crowd: true,
    ...
    },
    {
      ...
      stage: "ADAPT",
      cue: "Approval registered. Show the projected density falling after intervention.",
      mapCenter: IP03,
      mapZoom: 15,
      layers: { crowd: true, cameras: true, immersion: true, predictions: true, routes: true },
      heatZones: [
      ...
      panel: {
        impact: {
          ...
          before: [
            { label: "Utilization (+10m)", value: "104%" },
            { label: "Risk", value: "HIGH" },
          ],
          after: [
            { label: "Utilization (+10m)", value: "82%" },
      ...
      timeline: [
        { time: "20:42", text: "R-102 approved" },
        { time: "20:46", text: "Density stabilizing" },
      ],
    },
    {
      id: 5,
      ...
      stage: "DETECT",
      cue: "Introduce the emergency. Ask which route should be cleared now.",
      mapCenter: IP03,
      mapZoom: 15,
    ...
    },
    {
      ...
      panel: {
        ...
        impact: {
          ...
          before: [
            { label: "ETA to Hospital", value: "18 min" },
            { label: "Crowd risk", value: "STABLE" },
          ],
          after: [
            { label: "ETA to Hospital", value: "7 min" },
            { label: "Crowd risk", value: "STABLE" },
          ],
        },
      },
...
export const scenario2: Scenario = {
  id: "scenario2",
  name: "Procession Routing & Traffic Orchestration",
  headline: "Processions P-102 and P-108 → Immersion Point IP-02",
  stages: stagesFull,
  steps: [
    {
      id: 1,
      ...
      stage: "DETECT",
      cue: "Show pre-registration linking pandal, idol, procession, and vehicle records.",
    ...
    {
      id: 2,
      title: "Live Agent Synchronization",
      stage: "OBSERVE",
      cue: "Both processions are moving toward IP-02 and the ETA is visible.",
      ...
      timeline: [{ time: "20:34", text: "Platform synchronized · 2 processions tracked" }],
    },
    {
      id: 3,
      title: "Convergence Predicted",
      stage: "PREDICT",
      cue: "Combine current crowd, procession size, ETA, and road capacity.",
      mapCenter: IP02,
      mapZoom: 14,
      layers: {
        processions: true,
      ...
      alerts: [
        { severity: "WARNING", text: "Processions P-102 and P-108 predicted to converge on IP-02" },
      ],
    ...
    },
    {
      ...
      stage: "RECOMMEND",
      cue: "Objective: safest system-wide movement, not the shortest individual route.",
      mapCenter: [17.43, 78.44],
      mapZoom: 12,
      layers: { processions: true, immersion: true, routes: true, predictions: true },
      activeRoutes: [
    ...
    },
    {
      ...
      panel: {
        impact: {
          ...
          before: [
            { label: "IP-02", value: "128%" },
            { label: "Road R4", value: "SEVERE" },
            { label: "Emergency headroom", value: "None" },
          ],
          after: [
            { label: "IP-02", value: "84%" },
            { label: "Road R4", value: "MODERATE" },
            { label: "Emergency headroom", value: "Restored" },
          ],
        },
        recommendation: {
          title: "R-207",
...
export const scenario3: Scenario = {
  id: "scenario3",
  name: "Dynamic Immersion Planning & Resource Orchestration",
  headline: "Immersion Pass GNI-2026-0142 · Sri Vinayaka Youth Association",
  stages: stagesFull,
  steps: [
    {
      id: 1,
      ...
      stage: "OBSERVE",
      cue: "The pass carries the pandal, idol, procession, and vehicle context.",
      ...
      timeline: [{ time: "20:15", text: "Immersion Pass GNI-2026-0142 registered" }],
    },
    {
      id: 2,
      title: "Multi-constraint Suitability Analysis",
      stage: "SIMULATE",
      cue: "IP-03 is closest but the crane cannot lift a 2,200 kg, 16 ft idol. Distance is not enough.",
    ...
    },
    {
      ...
      stage: "RECOMMEND",
      cue: "Explain why this decision uses dimensions, crane capacity, queue, crowd, and traffic together.",
      mapCenter: [17.423, 78.46],
      mapZoom: 14,
      layers: { immersion: true, cranes: true, routes: true, processions: true },
      processions: [
    ...
    },
    {
      ...
      stage: "DETECT",
      cue: "A crane fault cascades into queue pressure, traffic spillback, and crowd growth.",
      mapCenter: IP02,
      mapZoom: 14,
      ...
      panel: {
        prediction: {
          ...
          body: "CR-07 fault will grow the IP-02 queue from 12 to 29 vehicles, wait time from 18 to 47 minutes, with HIGH road spillback risk and about 420 additional people accumulating.",
          horizonMin: 30,
          risk: "HIGH",
          items: [
      ...
      alerts: [
        { severity: "CRITICAL", text: "Crane CR-07 unavailable — cascade prediction generated" },
      ],
      timeline: [
        { time: "20:30", text: "CR-07 FAULT detected" },
        { time: "20:31", text: "Cascade prediction generated" },
      ],
    },
    {
      id: 5,
      ...
      stage: "SIMULATE",
      cue: "Compare keep, delay, and reallocate.",
    ...
    },
    {
      ...
      stage: "ADAPT",
      cue: "The immersion pass is dynamic and adapts to the real system state.",
      ...
      panel: {
        impact: {
          ...
          before: [
            { label: "Wait", value: "47 min" },
            { label: "Spillback", value: "HIGH" },
            { label: "Crowd risk", value: "Rising" },
          ],
          after: [
            { label: "Wait", value: "14 min" },
            { label: "Spillback", value: "Avoided" },
            { label: "Crowd risk", value: "Stable" },
          ],
        },
        recommendation: {
      ...
      alerts: [
        { severity: "INFO", text: "Pass GNI-2026-0142 dynamically updated · IP-05 / CR-12" },
      ],
      timeline: [
        { time: "20:33", text: "Pass reallocated · rerouted via R7" },
        { time: "20:34", text: "Digital Twin re-synchronized" },
      ],
    },
  ],
};
